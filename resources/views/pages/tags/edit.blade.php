    ...
    <div class="middle-content p-0 col-12 col-lg-9">
        ...
        <div class="mb-4 layout-spacing layout-top-spacing">
            <form class="widget-content widget-content-area ecommerce-create-section"
                action="{{ route('tag.update',$tag->slug) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row mb-4">
                    ...
                    <div class="col-12 col-md-6 form-group">
                        ...
                        <input type="text" class="form-control" name="tag_name" id="tag_name" value="{{$tag->tag_name}}">
                        @error('tag_name')
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 form-group mb-4">
                        ...
                        <input type="text" class="form-control" id="canonical_tag" name="canonical_tag" value="{{$tag->canonical_tag}}">
                        @error('canonical_tag')
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea class="form-control" id="meta_description" name="meta_description">{{$tag->meta_description}}</textarea>
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea class="form-control" id="meta_keywords" name="meta_keywords">{{$tag->meta_keywords}}</textarea>
                    @error('meta_keywords')
