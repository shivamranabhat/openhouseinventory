                    ...
                    <div class="meta-info">
                        ...
                        <div class="avatar--group">
                            ...
                            <div class="avatar translateY-axis">
                                <img alt="avatar" src="{{asset('src/assets/img/profile-8.jpg')}}"/>
                            </div>
                            <div class="avatar translateY-axis">
                                <img alt="avatar" src="{{asset('src/assets/img/profile-12.jpg')}}"/>
                            </div>
                            <div class="avatar translateY-axis">
                                <img alt="avatar" src="{{asset('src/assets/img/profile-19.jpg')}}"/>
                            </div>
