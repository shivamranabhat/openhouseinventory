        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu {{request()->segment(1) == 'product' || request()->segment(1)=='stock-in' ||request()->segment(1) == 'category'  ? 'active' : '' }}">
                        ...
                        <ul class="submenu list-unstyled collapse" id="product" data-bs-parent="#accordionExample" style="">
                            <li class="{{request()->segment(1) == 'product'  ? 'active' : '' }}">
                                <a href="{{route('products')}}"> Lists </a>
                            </li>
...
<!-- Mirrored from designreset.com/cork/html/vertical-dark-menu/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Sep 2024 13:18:07 GMT -->
</html>