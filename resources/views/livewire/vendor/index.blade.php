<div id="zero-config_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                ...
                <tr role="row">
                    ...
                    <td>
                        <span class="inv-date"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            </svg> {{\Carbon\Carbon::parse($vendor->created)->format('M d Y')}} </span>
                    </td>
                    <td class="d-flex">
                        @if($confirmingDeletion === $vendor->id)
                        <!-- Show Yes and No buttons -->
                        <div class="d-flex gap-2">
                            <button wire:click='delete({{$vendor->id}})' class="btn badge badge-danger">Yes</button>
                        ...
                        <a class="badge badge-light-primary text-start me-2 action-edit"
                            href="{{route('vendor.trans',$vendor->slug)}}"><svg xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a class="badge badge-light-info text-start me-2 action-edit"
                            href="{{route('vendor.edit',$vendor->slug)}}"><svg xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a class="badge badge-light-danger text-start action-delete" role="button"
                            wire:click='confirmDelete({{$vendor->id}})'><svg xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
    ...
    {{$vendors->links('vendor.pagination.pagination')}}
    <x-success />
    <x-error />
</div>