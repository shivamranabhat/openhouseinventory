            ...
            <tbody>
                ...
                <tr role="row">
                    ...
                    <td class="d-flex gap-3">
                        ...
                        <a data-bs-toggle="modal" data-bs-target="#modal-{{$employee->id}}" role="button">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="22" viewBox="0 0 24 24"
                        ...
                        <div id="modal-{{$employee->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer md-button">
                                        ...
                                        <button wire:click='remove({{$employee->slug}})' class="btn btn-danger">Delete</button>
                                    </div>
                                </div>
                            </div>
                        </div> 
    ...
    <div class="dt--bottom-section d-sm-flex justify-content-sm-between text-center">
        <div class="dt--pages-count mb-sm-0 mb-3">
            <div class="dataTables_info" role="status" aria-live="polite">
                Showing page {{ $employees->currentPage() }} of {{ $employees->lastPage() }}
            </div>
        </div>
