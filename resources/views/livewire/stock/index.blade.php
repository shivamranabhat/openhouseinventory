        ...
        <table id="zero-config" class="table table-striped dt-table-hover dataTable" style="width:100%" role="grid"
            ...
            <tbody>
                ...
                <tr role="row">
                    ...
                    <td>{{$stock->stock}}</td>
                    <td>{{\Carbon\Carbon::parse($stock->created)->format('M d Y')}}</td>
                    <td class="d-flex gap-3">
                        <a href="{{route('stock.edit',$stock->slug)}}">
                        ...
                        <a data-bs-toggle="modal" data-bs-target="#modal-{{$stock->id}}" role="button">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="22" viewBox="0 0 24 24"
                        ...
                        <div id="modal-{{$stock->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer md-button">
                                        ...
                                        <button wire:click='remove({{$stock->slug}})' class="btn btn-danger">Delete</button>
                                    </div>
                                </div>
                            </div>
                        </div> 
