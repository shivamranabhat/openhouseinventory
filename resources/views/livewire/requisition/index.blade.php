            ...
            <div class="tab-title">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-12 text-center mail-btn-container">
                        <a id="btn-compose-mail" class="btn btn-block _effect--ripple waves-effect waves-light"
                    ...
                    <div class="col-md-12 col-sm-12 col-12 mail-categories-container">
                        ...
                        <div class="mail-sidebar-scroll ps ps--active-y">
                            ...
                            <ul class="nav nav-pills d-block" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link list-actions active" id="mailInbox"><svg
                                            ...
                                            class="mail-badge badge">4</span></a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link list-actions" id="draft"><svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            class="mail-badge badge">2</span></a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link list-actions" id="spam"><svg xmlns="http://www.w3.org/2000/svg"
                                            width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link list-actions border-bottom-0" id="trashed"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="ps__rail-y" style="top: 0px; height: 476px; right: -15px;">
                ...
                <div class="action-center">
                    <div class="">
                        <div class="form-check form-check-primary form-check-inline mt-1" data-bs-toggle="collapse"
                            data-bs-target="">
                            <input class="form-check-input inbox-chkbox d-none" type="checkbox" id="inboxAll">
                        </div>
                    </div>

                    <div class="">
                        <a class="nav-link dropdown-toggle d-icon label-group" data-bs-toggle="dropdown" href="#"
                            role="button" aria-haspopup="true" aria-expanded="false"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" data-toggle="tooltip" data-placement="top" data-original-title="Label"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            data-toggle="tooltip" data-placement="top" data-original-title="Important"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            data-toggle="tooltip" data-placement="top" data-original-title="Spam"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" data-toggle="tooltip"
                            data-placement="top" data-original-title="Revive Mail" stroke-linejoin="round"
                            class="feather feather-activity revive-mail">
                            <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            data-toggle="tooltip" data-placement="top" data-original-title="Delete Permanently"
                        ...
                        <div class="dropdown d-inline-block more-actions">
                            ...
                            <div class="dropdown-menu left" aria-labelledby="more-actions-btns-dropdown" style="">
                ...
                <div class="message-box">
                    <div class="message-box-scroll ps ps--active-y" id="ct">
                        <div id="unread-verification-link" class="mail-item mailInbox">
                            ...
                            <div class="animated animatedFadeInUp fadeInUp" id="{{$request->id}}">
                                <div class="mb-0">
                                    <div class="mail-item-heading social collapsed" data-bs-toggle="collapse"
                                        role="navigation" data-bs-target="#{{$request->id}}" aria-expanded="false">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="f-body">
                                                    <div class="meta-mail-time">
                                                        <p class="user-email">{{$request->employee->name}}</p>
                                                    </div>
                                                    <div class="meta-title-tag">
                                                        <p class="mail-content-excerpt"> <span class="mail-title">New
                                                                Item Request - </span>
                            ...
                            <div class="animated animatedFadeInUp fadeInUp">
                                <div class="mb-0">
                                    <div class="mail-item-heading social collapsed" data-bs-toggle="collapse"
                                        role="navigation" data-bs-target="#mailCollapseEleven" aria-expanded="false">
                                        <div class="mail-item-inner">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="f-body">
                                                    ...
                                                    <div class="meta-title-tag">
                                                        <p class="mail-content-excerpt"><span class="mail-title"
                                                                data-mailtitle="No Request Found">No Request Found
                                                            </span></p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="ps__rail-x" style="left: 0px; bottom: 0px; display: none;">
                            <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>
                        </div>
                        <div class="ps__rail-y" style="top: 0px; height: 470px; right: 0px; display: none;">
                        ...
                        <div class="mail-content-container mailInbox">
                            <div class="d-flex justify-content-between mb-5">
                                <div class="d-flex user-info">
                                    ...
                                    <div class="f-body">
                                        <div class="meta-title-tag">
                                            <h4 class="mail-usr-name">{{$request->employee->name}}</h4>
                                        </div>
                                        <div class="meta-mail-time">
                                            <p class="user-email">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-4 mail-form">
                                                ...
                                                <select class="form-control" id="m-form">
                                                    ...
                                                    <option value="shaun@mail.com">Shaun Park &lt;shaun@mail.com&gt;
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="btn-save"
                            class="btn float-left btn-success _effect--ripple waves-effect waves-light"> Save</button>
                        <button id="btn-reply-save"
                            class="btn float-left btn-success _effect--ripple waves-effect waves-light"> Save
                            Reply</button>
                        <button id="btn-fwd-save"
                            class="btn float-left btn-success _effect--ripple waves-effect waves-light"> Save
                            Fwd</button>
                        ...
                        <button id="btn-reply" class="btn btn-primary _effect--ripple waves-effect waves-light">
                            Reply</button>
                        <button id="btn-fwd" class="btn btn-primary _effect--ripple waves-effect waves-light">
                            Forward</button>
                        <button id="btn-send" class="btn btn-primary _effect--ripple waves-effect waves-light">
                            Send</button>
                    </div>
                </div>
            </div>
