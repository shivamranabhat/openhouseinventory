    ...
    <div class="dt--top-section">
        <div class="row">
            ...
            <div
                ...
                <a href="{{route('card.create')}}" class="form-create flex justify-content-between align-items-center">
        ...
        <table id="zero-config" class="table table-striped dt-table-hover dataTable" style="width:100%" role="grid"
            ...
            <tbody wire:poll.keep-alive>
                ...
                <tr role="row">
                    ...
                    <td class="d-flex">
                        <a class="badge badge-light-danger text-start action-delete" wire:click="restore({{$twitter->id}})"
                            role="button">
