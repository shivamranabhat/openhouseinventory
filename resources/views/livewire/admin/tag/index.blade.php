            ...
            <tbody wire:poll.keep-alive>
                ...
                <tr role="row">
                    ...
                    <td> <span class="inv-date"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            </svg> {{\Carbon\Carbon::parse($tag->created_at)->format('M d Y')}} </span></td>
                    <td class="d-flex">
                        @if($confirmingDeletion === $tag->id)
                        <!-- Show Yes and No buttons -->
                        <div class="d-flex gap-2">
                            <button wire:click="delete({{$tag->id}})" class="btn badge badge-danger">Yes</button>
