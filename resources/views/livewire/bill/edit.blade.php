                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <select class="form-select" wire:model='vendor_id'
                                                ...
                                                <option value="{{$bill->vendor_id}}" selected>{{$bill->vendor->name}}
                                                </option>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 mt-4">
                                <button wire:click='save'
                                    class="btn btn-primary btn-download _effect--ripple waves-effect waves-light">
                                    <x-spinner />Save
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="col-10">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" wire:model='charge_id'
                                        ...
                                        <option value="{{ $charge->id }}" {{ $extra_charge_id==$charge->id ? 'selected' : ''
                                            }}>
                                            {{ $charge->name }}
                                        </option>
                                        @empty
