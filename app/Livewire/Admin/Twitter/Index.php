...
class Index extends Component
{
    ...
    public function delete($id)
    {
        if (Gate::allows('super-admin')) {
            TwitterCard::find($id)->update(['status'=>'Inactive']);
            $this->confirmingDeletion = null;
            session()->flash('success','Twitter card deleted successfully');
        } else {
    ...
    public function render()
    {
        ...
        return view('livewire.admin.twitter.index',['twitters'=>$twitters]);
    }
}
